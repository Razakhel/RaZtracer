...
int main() {
  ...
  scene.addShape(std::make_unique<Triangle>(Vec3f({ 6.f, 0.f, 3.f }), Vec3f({ 3.f, -1.f, 3.f}), Vec3f({ 1.5f, 2.f, 3.f })));

  scene.addShape(std::make_unique<Box>(Vec3f({ 5.f, 3.f, 3.f }), Vec3f({ 2.f, 1.f, 5.f })));
